...
class VisualizationTab(wx.Panel):
    def __init__(self, parent):
        ...
        bsizer_label_trans = wx.StaticBoxSizer(wx.VERTICAL, self, _("Label Transparency"))
        lbl_transparency = wx.StaticText(
            bsizer_label_trans.GetStaticBox(), -1, _("Measurement label transparency (2D and 3D)")
        )
        sl_transparency = self.sl_transparency = wx.Slider(
            bsizer_label_trans.GetStaticBox(),
            -1,
        ...
        bsizer_label_trans.Add(lbl_transparency, 0, wx.TOP | wx.LEFT | wx.FIXED_MINSIZE, 10)
        bsizer_label_trans.Add(
            sl_transparency, 0, wx.TOP | wx.LEFT | wx.EXPAND | wx.FIXED_MINSIZE, 5
        )
        ...
        border.Add(bsizer_label_trans, 0, wx.EXPAND | wx.ALL | wx.FIXED_MINSIZE, 10)
